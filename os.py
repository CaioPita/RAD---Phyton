...
def criar_diretorio(nome_diretorio: str) -> None:
    try:
        ...
        print(f"Ocorreu um erro ao criar um diretório'{nome_diretorio}': {e}")
...
def criar_arquivo(arquivo_nome: str,conteudo: str) -> None:
    try:
        ...
        print(f"Ocorreu um erro ao criar um arquivo'{arquivo_nome}': {e}")
def main() -> None:
    ...
    try:
        ...
        print("O caminho esecificado não foi encontrado!")
    except PermissionError:
        print("Permissão negada para acessar o caminho específico")
    except Exception as e:
